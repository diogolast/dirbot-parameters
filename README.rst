...
To run the application with parameters, open your terminal em execute::

	scrapy crawl dmoz -a url=http://www.dmoz.org/Computers/Programming/Languages/Python/Books/

Export JSON
=========

To export in JSON, open your terminal em execute::

	scrapy crawl dmoz -a url=http://www.dmoz.org/Computers/Programming/Languages/Python/Books/ -o items.json
